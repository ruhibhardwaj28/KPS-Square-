  ...
  const services = [
    {
      ...
      description:
        "Comprehensive tax strategies to minimize liabilities and ensure full compliance with regulations.",
      icon: "📊",
    },
    {
      title: "GST Services",
      description:
        "Complete GST registration, return filing, and compliance management for businesses.",
      icon: "🧾",
    },
    {
      title: "Company Incorporation",
      description:
        "End-to-end company registration and LLP formation services with regulatory compliance.",
      icon: "🏢",
    },
    {
      title: "Audit & Assurance",
      description:
        "Statutory audits, internal audits, and financial assurance services for transparency.",
      icon: "🔍",
    },
    {
      title: "Transfer Pricing",
      description:
        "International transfer pricing documentation and compliance for multinational entities.",
      icon: "🌐",
    },
    {
      title: "Financial Advisory",
      description:
        "Strategic financial planning and advisory services for business growth and optimization.",
      icon: "💡",
    },
  ];
        ...
        <div className="relative z-10 container-width text-center text-white">
          <div className="animate-fade-in">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
              ...
              expert financial solutions. Together, we unlock opportunities,
              drive sustainable growth, and build a brighter financial future.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                asChild
                variant="outline"
                className="btn-outline-corporate text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-primary"
              >
        ...
        <div className="container-width">
          <div className="text-center mb-16">
            ...
            <p className="text-corporate text-lg max-w-3xl mx-auto">
              Comprehensive financial and business services tailored to meet
              your specific needs. From startups to established enterprises, we
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in">
              ...
              <p className="text-corporate text-lg mb-6">
                We provide all types of services under one roof, ensuring
                convenience, professionalism, and quality in everything we do.
                Our goal is to simplify your journey by offering reliable
                solutions tailored to your unique needs, helping you focus on
                what truly matters — growth and success.
              </p>
              ...
              <Card className="card-corporate p-8">
                <div className="text-center">
                  ...
                  <p className="text-corporate mb-6">
                    Our commitment to excellence and integrity has established
                    us as a trusted and respected name in the industry.
                  </p>
      ...
      <section id="contact" className="section-padding bg-muted">
        <div className="container-width">
          <div className="text-center mb-12">
            ...
            <p className="text-corporate text-lg max-w-2xl mx-auto">
              We'd love to learn about your needs.
            </p>
          </div>
              ...
              <CardContent className="p-6">
                <form
                  ...
                  onSubmit={(e) => {
                    ...
                    const message = (
                      form.message as HTMLTextAreaElement
                    ).value.trim();
      ...
      >
        <div className="container-width text-center text-white">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Schedule a free consultation with our expert chartered accountants
            and discover how we can help optimize your business finances.
          </p>
          <Button
            asChild
            variant="secondary"
